...
void loop(void){
  ...
  flex_1_val = map(flex_1_val, 530, 575, 5, 150);
  
  flex_2_val = analogRead(flex_2);
  flex_2_val = map(flex_2_val, 520, 590, 180, 35);
 
  flex_3_val = analogRead(flex_3);
  flex_3_val = map(flex_3_val, 520, 600, 5, 150);
 
  flex_4_val = analogRead(flex_4);
  flex_4_val = map(flex_4_val, 520, 600, 5, 150);
  
  flex_5_val = analogRead(flex_5);
  flex_5_val = map(flex_5_val, 510, 580, 180, 35);
